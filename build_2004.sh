...
rm -rf ${WORKING_DIR}
curl -L https://storage.openvinotoolkit.org/repositories/openvino/packages/2023.1/linux/l_openvino_toolkit_ubuntu${UBUNTU_VERSION}_2023.1.0.12185.47b736f63ed_x86_64.tgz --output /tmp/openvino_2023.1.0.tgz
tar -xf /tmp/openvino_2023.1.0.tgz -C /tmp
mkdir -p ${WORKING_DIR}
mv /tmp/l_openvino_toolkit_ubuntu${UBUNTU_VERSION}_2023.1.0.12185.47b736f63ed_x86_64 ${OVINO_DIR}
...
mv ${WORKING_DIR}/package_output.deb ${WORKING_DIR}/openvino_${VERSION}_${UBUNTU_VERSION}04_amd64.deb
